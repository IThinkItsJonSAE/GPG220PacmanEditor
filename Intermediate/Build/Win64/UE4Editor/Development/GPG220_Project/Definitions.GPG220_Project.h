...
#define ORIGINAL_FILE_NAME "UE4Editor-GPG220_Project.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME GPG220_Project
#define DEPRECATED_FORGAME DEPRECATED
#define GPG220_PROJECT_API DLLEXPORT
